  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'w-full max-w-lg bg-bg-surface border border-border rounded-2xl shadow-card p-6',
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 text-text-muted hover:text-text-primary hover:bg-bg-elevated transition-colors">
        <X className="h-4 w-4" />
